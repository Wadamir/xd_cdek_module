...
class ControllerToolCdekTool extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('tool/cdek_tool', 'user_token=' . $this->session->data['user_token'], 'SSL')
        );
        ...
        $license = $this->model_tool_cdek_tool->checkLicense();
        ...
        $data['action'] = $this->url->link('tool/cdek_tool', 'user_token=' . $this->session->data['user_token'], 'SSL');

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer'] = $this->load->controller('common/footer');

        $this->response->setOutput($this->load->view('tool/cdek_tool', $data));
    }
}
