...
$_['text_help_schedule']                    = 'Данные заполняются только если ИМ запрашивает у получателя расписание для доставки/забора отправления (Определено в договоре).';
$_['text_help_schedule_detail']            = '<ul class="help"><li>На одну дату по одному заказу может быть только одно расписание;</li><li>В один день возможен один временной интервал не менее 3 часов;</li><li>Расписание можно задать только на будущую дату;</li><li>Расписание может быть передано позже.</li></ul>';
...
$_['text_update_city']                    = 'Обновить базу городов';
