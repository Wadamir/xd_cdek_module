...
от статуса СДЭК проставленный в настройках отгрузки */
        ...
        $this->model_setting_event->addEvent('cdek_shipping_add_scripts', 'catalog/controller/common/header/before', 'event/cdek_shipping/addScripts');

        $this->model_setting_event->addEvent('cdek_shipping_success_order', 'catalog/controller/checkout/success/before', 'event/cdek_shipping/successOrder');

        $this->model_setting_event->addEvent('cdek_shipping_order_create', 'catalog/model/checkout/order/addOrder/after', 'event/cdek_shipping/orderCreate');

        $this->model_setting_event->addEvent('cdek_shipping_order_history', 'catalog/model/checkout/order/addOrderHistory/before', 'event/cdek_shipping/orderHistory');

        $this->model_setting_event->addEvent('cdek_shipping_check_tariff_pvz', 'catalog/controller/checkout/shipping_method/save/before', 'event/cdek_shipping/checkTariffPvz');
    }
