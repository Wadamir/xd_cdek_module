          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="cdek-default-data"><?php echo $entry_default_data; ?></label>
                <div class="col-sm-10">
                  <select class="form-control" id="cdek-default-data" name="cdek_integrator_setting[cdek_default_data][use]">
                    <?php foreach ($boolean_variables as $key => $variable) { ?>
                    <option value="<?php echo $key; ?>"<?php if ((!empty($setting['cdek_default_data']['use']) && ($setting['cdek_default_data']['use'] == $key))) { ?>selected="selected"<?php } ?>><?php echo $variable; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>

              <?php $style['cdek-default-data_parameters'] = ''; ?>
              <?php if (isset($setting['cdek_default_data']['use']) && (($setting['cdek_default_data']['use'] == '0') ||  !$setting['cdek_default_data']['use'])) { ?>
              <?php $style['cdek-default-data_parameters'] = 'style="display:none"'; ?>
              <?php } ?>
              <div id="cdek-default-data_parameters" class="col-sm-offset-2 col-sm-10"<?php echo $style['cdek-default-data_parameters']; ?>>
              ...
              <div class="form-group required" id="cdek-default-data-type_size">
                ...
                <div class="col-sm-10 form-inline">
                  <input class="form-control" type="text" placeholder="<?php echo $text_short_length; ?>" name="cdek_integrator_setting[cdek_default_data][size_a]" value="<?php if (!empty($setting['cdek_default_data']['size_a'])) { ?><?php echo $setting['cdek_default_data']['size_a']; ?><?php } ?>" size="3" /> x
                  <input class="form-control" type="text" placeholder="<?php echo $text_short_width; ?>" name="cdek_integrator_setting[cdek_default_data][size_b]" value="<?php if (!empty($setting['cdek_default_data']['size_b'])) { ?><?php echo $setting['cdek_default_data']['size_b']; ?><?php } ?>" size="3" /> x
                  <input class="form-control" type="text" placeholder="<?php echo $text_short_height; ?>" name="cdek_integrator_setting[cdek_default_data][size_c]" value="<?php if (!empty($setting['cdek_default_data']['size_c'])) { ?><?php echo $setting['cdek_default_data']['size_c']; ?><?php } ?>" size="3" />
                  <?php if (isset($error['setting']['cdek_default_data']['size'])) { ?>
                  <div class="text-danger"><?php echo $error['setting']['cdek_default_data']['size']; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for=""><?php echo $entry_weight_default; ?></label>
                <div class="col-sm-10 form-inline">
                  <input class="form-control" id="cdek-default-param-value" type="text" name="cdek_integrator_setting[cdek_default_data][weight]" value="<?php if (!empty($setting['cdek_default_data']['weight'])) { ?><?php echo $setting['cdek_default_data']['weight']; ?><?php } ?>" size="3" /> кг.
                  <?php if (isset($error['setting']['cdek_default_data']['weight'])) { ?>
                  <div class="text-danger"><?php echo $error['setting']['cdek_default_data']['weight']; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for=""><?php echo $entry_data_work_mode_default; ?></label>
                <div class="col-sm-10">
                  <select class="form-control" id="cdek-default-data-work-mode" name="cdek_integrator_setting[cdek_default_data][work_mode]">
                    <?php foreach ($default_work_mode as $key => $mode) { ?>
                    <option value="<?php echo $key; ?>"<?php if ((!empty($setting['cdek_default_data']['work_mode']) && ($setting['cdek_default_data']['work_mode'] == $key))) { ?>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="setting-shipment-point-default"><?php echo $entry_shipment_point_default; ?></label>
              <div class="col-sm-10">
                <select id="setting-city-default" name="cdek_integrator_setting[shipment_point_default]" class="form-control">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($pvz_list_sell as $pvz_info) { ?>
                  <option <?php if (isset($setting['shipment_point_default']) && $pvz_info['Code'] == $setting['shipment_point_default']) echo 'selected="selected"'; ?>value="<?php echo $pvz_info['Code']; ?>"><?php echo $pvz_info['Name']; ?> (<?php echo $pvz_info['Address']; ?>
                    )</option>
                  <?php } ?>
                </select>
              </div>
      ...
      $(this).autocomplete({
        source: function(request,response) {
          $.ajax({
            ...
            dataType: "jsonp",
            data: {
              q: function () { return $('.setting-city-name').val() },
              name_startsWith: function () { return $('.setting-city-name').val() }
            },
        ...
        select: function(event) {
          ...
          $('.setting-city-name', context).show();
